...
<head>
    ...
    <title>充钱页面</title>
    <meta name="description" content="充钱页面">
    <meta name="keywords" content="充钱页面">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/user/findAll.do">我的账户</a></li>
                <li class="active">充钱</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/member/chongqian"
              method="post">
            <!-- 正文区域 -->
            <section class="content"> <!--产品信息-->

                <div class="panel panel-default">
                    <div class="panel-heading">充钱信息</div>

                    <div class="row data-type">

                        <div class="col-md-2 title">账户当前余额</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" value="${balance}" readonly >
                        </div>

                        <div class="col-md-2 title">输入充值金额</div>
                        <div class="col-md-4 data">
                ...
                <div class="box-tools text-center">
                    <button type="submit" class="btn bg-maroon">充值</button>
