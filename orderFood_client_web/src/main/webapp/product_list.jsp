    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/user/findAll.do">菜单</a></li>
                                ...
                                <c:forEach items="${products.list}" var="product">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="${pageContext.request.contextPath}/car/del?productId=${product.id}"
                                               class="btn bg-olive btn-xs">-</a>
                                            <span>1</span>
                                            <a href="${pageContext.request.contextPath}/car/add?productId=${product.id}"
                                               class="btn bg-olive btn-xs">+</a>
                                        </td>
                                    </tr>
                                </c:forEach>
