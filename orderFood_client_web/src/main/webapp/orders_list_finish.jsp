...
<head>
    ...
    <title>已配送的订单</title>
    <meta name="description" content="已配送的订单">
    <meta name="keywords" content="已配送的订单">
...
<script>
    function changePageSize() {
        ...
        location.href = "${pageContext.request.contextPath}/orders/allByRiderId?pageNum=1&pageSize=" + pageSize;
    }
