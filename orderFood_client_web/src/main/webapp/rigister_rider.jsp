...
<head>
    ...
    <title>注册骑手页面</title>
    <meta name="description" content="注册骑手页面">
    <meta name="keywords" content="注册骑手页面">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/user/findAll.do">注册骑手</a></li>
                <li class="active">注册信息</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/member/rigisterRider"
              method="post">
            <!-- 正文区域 -->
            <section class="content"> <!--产品信息-->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-5 title">*注册成为骑手需要交纳200押金和100服装费用，请保证账户余额充足，输入支付密码：</div>
                ...
                <div class="box-tools text-center">
                    <button type="submit" class="btn bg-maroon">确认支付，注册为骑手</button>
